...
function ResetPasswordForm() {
    ...
    // ส่วนที่เหลือของโค้ด validatePassword และ handleSubmit ยังคงเหมือนเดิม
...
export default function ResetPasswordPage() {
    // หน้าหลักไม่มีการใช้ useSearchParams โดยตรงอีกต่อไป
    return (
        <div className="flex h-screen w-full">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-between p-8">
                ...
                {/* Reset Password Form ที่ครอบด้วย Suspense */}
                <Suspense fallback={<div className="flex-grow flex flex-col justify-center max-w-md">
                    <h2 className="text-2xl font-bold mb-6">กำลังโหลด...</h2>
                </div>}>
                    <ResetPasswordForm />
                </Suspense>
